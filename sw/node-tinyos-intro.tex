...
\subsection{Network Protocols in TinyOS}
 ...
 paper:ts4,paper:ts2,paper:ts3,paper:ts1, Lenzen2010Clock,
 Lenzen2009Optimal, Sommer2009Gradient, Sommer2008Symmetric} and the
 mainstream repository of \emph{TinyOS} source code already contains
 implementations for some of the proposed protocols \TEP{99999}.
